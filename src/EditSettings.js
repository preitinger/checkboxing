...
class EditSettings extends React.Component<{settings: Settings.Settings, onApply:Settings.Settings => void}, {settings: Settings.Settings}> {
  ...
  render(): React.Node {
    ...
    return (
      <div className='editSettings'>
        <h3 className='setting'>Einstellungen</h3>
        ...
        <button onClick={() => this.props.onApply(s)}>Übernehmen</button>
      </div>
    );
  }
}
